...
mean(bcd.all3.r10[,2]) # 0.2789277
min(bcd.all3.r10[,2]) # 0.2653374

(0.2880853 - 0.2789277)/0.2880853*100
# 3.178781

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.007536761  0.052312571 10.182676009  0.010429700  0.101146245  4.572592344 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -24.632391   4.625141   1.826760   4.296998   1.146245  -8.548153 
