...
mean(bcd.all3.r9.valid[,2]) # 0.3885883
min(bcd.all3.r9.valid[,2]) # 0.3578353

(0.4079905 - 0.3885883)/0.4079905*100
# 4.755552

paras.final.est <- apply(paras.all3.r9, 2, mean)
# 0.01038366  0.04486470 10.07812342  0.01039657  0.10158171  4.35676714 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 3.8365673 -10.2705935   0.7812342   3.9657377   1.5817070 -12.8646573 
