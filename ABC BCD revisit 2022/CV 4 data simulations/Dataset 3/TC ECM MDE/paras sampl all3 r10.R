...
mean(bcd.all3.r10[,2]) # 0.2843777
min(bcd.all3.r10[,2]) # 0.2679783

(0.2965994-0.2843777)/0.2965994*100
# 4.120608

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.011106932 0.053700244 9.828599829 0.009515792 0.100628070 5.126741018 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 11.0693219  7.4004870 -1.7140017 -4.8420774  0.6280697  2.5348204 
