...
mean(bcd.all3.r10[,2]) # 0.3241415
min(bcd.all3.r10[,2]) # 0.298656

(0.3397991 - 0.3241415)/0.3397991*100
# 4.607899

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.009116072  0.055412400 10.061543093  0.009643112  0.100234812  5.052463037 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -8.8392837 10.8248006  0.6154309 -3.5688824  0.2348121  1.0492607 
