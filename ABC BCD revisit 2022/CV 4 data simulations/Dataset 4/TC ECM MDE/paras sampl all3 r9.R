...
mean(bcd.all3.r9[,2]) # 0.2635676
min(bcd.all3.r9[,2]) # 0.231614

(0.2768346 - 0.2635676)/0.2768346*100
# 4.792392

paras.final.est <- apply(paras.all3.r9, 2, mean)
# 0.01075619 0.04360554 9.98000705 0.01034755 0.10184356 4.28022754 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 7.5619279 -12.7889263  -0.1999295   3.4754542   1.8435562 -14.3954491 
