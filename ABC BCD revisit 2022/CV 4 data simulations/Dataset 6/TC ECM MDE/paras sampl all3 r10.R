...
mean(bcd.all3.r10[,2]) # 0.3266361
min(bcd.all3.r10[,2]) # 0.3072382

(0.3368405 - 0.3266361)/0.3368405*100
# 3.029446

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.009430297  0.051504043 10.087017098  0.010166592  0.099741583  4.547718484 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -5.6970251  3.0080862  0.8701710  1.6659223 -0.2584168 -9.0456303 
