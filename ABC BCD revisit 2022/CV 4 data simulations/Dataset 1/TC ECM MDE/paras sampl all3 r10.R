...
mean(bcd.all3.r10[,2]) # 0.279046
min(bcd.all3.r10[,2]) # 0.2536163

(0.2912934 - 0.279046)/0.2912934*100
# 4.204489

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.009324467  0.050361193 10.029151744  0.010203811  0.101662876  4.585432290 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -6.7553333  0.7223869  0.2915174  2.0381102  1.6628756 -8.2913542 
