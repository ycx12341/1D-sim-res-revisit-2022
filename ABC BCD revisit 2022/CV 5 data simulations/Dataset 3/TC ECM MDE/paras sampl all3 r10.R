...
mean(bcd.all3.r10.valid[,2]) # 0.5188865
min(bcd.all3.r10.valid[,2]) # 0.4858737

(0.5405091 - 0.5188865)/0.5405091*100
# 4.000414

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.005020156  0.060732736 10.018645508  0.010597998  0.101423705  5.035697025 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -49.7984380  21.4654721   0.1864551   5.9799753   1.4237047   0.7139405 
