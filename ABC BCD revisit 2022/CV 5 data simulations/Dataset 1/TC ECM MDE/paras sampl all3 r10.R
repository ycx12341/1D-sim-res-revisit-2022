...
mean(bcd.all3.r10[,2]) # 0.4925949
min(bcd.all3.r10[,2]) # 0.4621877

(0.5140966 - 0.4925949)/0.5140966*100
# 4.182424

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.009000761  0.048223897 10.249117503  0.009986316  0.102389107  4.168368915 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -9.9923866  -3.5522065   2.4911750  -0.1368411   2.3891068 -16.6326217 
