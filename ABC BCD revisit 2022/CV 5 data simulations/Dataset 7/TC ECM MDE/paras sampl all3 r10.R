...
mean(bcd.all3.r10[,2]) # 0.467816
min(bcd.all3.r10[,2]) # 0.4321845

(0.4874865 - 0.467816)/0.4874865*100
# 4.035086

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.009260843  0.052933297 10.140187514  0.009723561  0.101570891  4.635252282 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -7.391566  5.866594  1.401875 -2.764392  1.570891 -7.294954 
