...
mean(bcd.all3.r10[,2]) # 0.5448818
min(bcd.all3.r10[,2]) # 0.5099567

(0.5670071 - 0.5448818)/0.5670071*100
# 3.90212

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.006412411  0.053012803 10.391635313  0.010644183  0.100725050  4.143433417 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -35.8758905   6.0256065   3.9163531   6.4418268   0.7250498 -17.1313317 
