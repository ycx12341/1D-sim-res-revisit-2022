...
mean(bcd.all3.r10.valid[,2]) # 0.6161837
min(bcd.all3.r10.valid[,2]) # 0.5633987

(0.6394098 - 0.6161837)/0.6394098*100
# 3.632428

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.006613773  0.060253047 10.205030568  0.009997802  0.100653170  5.000972389 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -33.86226601  20.50609438   2.05030568  -0.02197518   0.65316966   0.01944778 
