...
mean(bcd.all3.r4.valid[,2]) # 0.07141678
min(bcd.all3.r4.valid[,2]) # 0.006385858

(0.07141678 - 3.689559)/3.689559 * 100
# -98.06435

paras.final.est <- apply(paras.all3.r4, 2, mean)
# 0.011160306 0.054356867 9.985261555 0.009668433 0.099630859 5.465315846 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 11.6030639  8.7137338 -0.1473844 -3.3156679 -0.3691408  9.3063169 
