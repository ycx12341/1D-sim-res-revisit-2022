...
mean(bcd.all3.r5[,2]) # 0.02975315
min(bcd.all3.r5[,2]) # 0.008163277

(0.02975315 - 3.807725)/3.807725*100
# -99.21861

paras.final.est <- apply(paras.all3.r5, 2, mean)
# 0.009725948 0.051625905 9.950656016 0.010095960 0.099839310 5.157140775 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -2.7405184  3.2518109 -0.4934398  0.9596030 -0.1606897  3.1428155 
