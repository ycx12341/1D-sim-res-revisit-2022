...
mean(bcd.all3.r5[,2]) # 0.0415352
min(bcd.all3.r5[,2]) # 0.01079233

(0.0415352 - 3.793848)/3.793848*100
# -98.9052

paras.final.est <- apply(paras.all3.r5, 2, mean)
# 0.009401011  0.051942065 10.106646063  0.009885828  0.100456596  5.123619565 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -5.9898891  3.8841298  1.0664606 -1.1417193  0.4565958  2.4723913 
