...
mean(bcd.all3.r5[,2]) # 0.03321702
min(bcd.all3.r5[,2]) # 0.01024159

(0.03321702 - 3.916861)/3.916861*100
# -99.15195

paras.final.est <- apply(paras.all3.r5, 2, mean)
# 0.011867285 0.053801625 9.835178407 0.009508685 0.099870392 5.491040067 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 18.6728503  7.6032494 -1.6482159 -4.9131527 -0.1296077  9.8208013 
