...
mean(bcd.all3.r5[,2]) # 0.06396198
min(bcd.all3.r5[,2]) # 0.01353005

(0.06396198 - 3.682536)/3.682536*100
# -98.2631

paras.final.est <- apply(paras.all3.r5, 2, mean)
# 0.009973113  0.050870433 10.074825423  0.010137974  0.100247951  5.070867062 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -0.2688710  1.7408650  0.7482542  1.3797432  0.2479513  1.4173412 
