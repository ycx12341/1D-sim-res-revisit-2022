...
mean(bcd.all3.r5[,2]) # 0.03166939
min(bcd.all3.r5[,2]) # 0.07962943

(0.03166939 - 3.674538)/3.674538*100
# -99.13814

paras.final.est <- apply(paras.all3.r5, 2, mean)
# 0.009886176  0.051985634 10.008388974  0.010073857  0.100034185  5.179625334 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -1.13823627  3.97126728  0.08388974  0.73856600  0.03418478  3.59250669 
