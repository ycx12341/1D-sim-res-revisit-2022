...
mean(bcd.all3.r5[,2]) # 0.03496323
min(bcd.all3.r5[,2]) # 0.008143004

(0.03496323 - 3.717719)/3.717719*100
# -99.05955

paras.final.est <- apply(paras.all3.r5, 2, mean)
# 0.010318482 0.054502356 9.939573311 0.009647018 0.100294876 5.397240185 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 3.1848203  9.0047117 -0.6042669 -3.5298164  0.2948757  7.9448037 
