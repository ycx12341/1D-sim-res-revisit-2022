...
mean(bcd.all3.r6[,2]) # 0.05774587
min(bcd.all3.r6[,2]) # 0.03282544

(0.05774587 - 3.825976)/3.825976*100
# -98.49069

paras.final.est <- apply(paras.all3.r6, 2, mean)
# 0.011636890  0.049459989 10.034064974  0.009755126  0.099817300  4.990572534 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 16.3688999 -1.0800224  0.3406497 -2.4487446 -0.1827004 -0.1885493 
