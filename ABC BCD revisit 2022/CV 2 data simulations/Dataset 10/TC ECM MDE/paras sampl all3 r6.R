...
mean(bcd.all3.r6[,2]) # 0.06321147
min(bcd.all3.r6[,2]) # 0.03828011

(0.06321147 - 3.809703)/3.809703 * 100
# -98.34078

paras.final.est <- apply(paras.all3.r6, 2, mean)
# 0.010768161 0.051175075 9.977141238 0.009878383 0.100010679 5.090480749 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 7.68161104  2.35015042 -0.22858762 -1.21617239  0.01067874  1.80961498 
