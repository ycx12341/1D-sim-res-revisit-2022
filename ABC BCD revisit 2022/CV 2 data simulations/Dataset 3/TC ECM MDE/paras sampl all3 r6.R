...
mean(bcd.all3.r6[,2]) # 0.05832824
min(bcd.all3.r6[,2]) # 0.03007822

(0.05832824 - 3.886695)/3.886695*100
# -98.49928

paras.final.est <- apply(paras.all3.r6, 2, mean)
# 0.01013968 0.04957714 9.99837789 0.01020102 0.10032110 4.99631417 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 1.39675275 -0.84572958 -0.01622112  2.01016641  0.32110089 -0.07371652 
