...
mean(bcd.all3.r6[,2]) # 0.05195265
min(bcd.all3.r6[,2]) # 0.0340058

(0.05195265 - 3.826472)/3.826472*100
# -98.64228

paras.final.est <- apply(paras.all3.r6, 2, mean)
# 0.012125315 0.052660269 9.872815107 0.009606076 0.099611146 5.300889203 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 21.2531528  5.3205388 -1.2718489 -3.9392371 -0.3888535  6.0177841 
