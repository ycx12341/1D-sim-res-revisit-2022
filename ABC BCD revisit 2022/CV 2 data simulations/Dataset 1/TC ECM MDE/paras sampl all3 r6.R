...
mean(bcd.all3.r6[,2]) # 0.0652772
min(bcd.all3.r6[,2]) # 0.03639813

(0.0652772 - 3.840743)/3.840743*100
# -98.3004

paras.final.est <- apply(paras.all3.r6, 2, mean)
# 0.010477857 0.052565589 9.958873246 0.009999623 0.099607388 5.213895410 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 4.778565852  5.131178965 -0.411267542 -0.003769452 -0.392611739  4.277908195 
