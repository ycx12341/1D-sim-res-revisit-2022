...
mean(bcd.all3.r10[,2]) # 0.1319568
min(bcd.all3.r10[,2]) # 0.1243253

(0.1378063 - 0.1319568)/0.1378063*100
# 4.244726

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.011091076 0.047965172 9.926985413 0.009993463 0.100083699 4.640764644 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 10.91075659 -4.06965520 -0.73014587 -0.06537422  0.08369879 -7.18470712 
