...
mean(bcd.all3.r10[,2]) # 0.1130503
min(bcd.all3.r10[,2]) # 0.09802469

# Resample and record the parameter values to be evaluated in the next round. 
set.seed(123)
RNGkind(sample.kind = "Rejection")
paras.all3.r11 <- abc.bcd(ss.mat = bcd.all3.r10, paras = paras.all3.r10, bw = 19.22168)
write.table(paras.all3.r11, "Round 11 parameters 10000 all 3.txt")
