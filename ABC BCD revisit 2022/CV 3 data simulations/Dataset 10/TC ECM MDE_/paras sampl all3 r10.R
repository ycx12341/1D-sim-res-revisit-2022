...
mean(bcd.all3.r10[,2]) # 0.1335074
min(bcd.all3.r10[,2]) # 0.1233279

(0.139731 - 0.1335074)/0.139731*100
# 4.453987

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.00977815 0.04613320 9.99864535 0.01024705 0.10125979 4.27850586 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -2.2184958  -7.7336072  -0.0135465   2.4705342   1.2597904 -14.4298828 
