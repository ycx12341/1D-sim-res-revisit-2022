...
mean(bcd.all3.r10[,2]) # 0.1471287
min(bcd.all3.r10[,2]) # 0.1352219

(0.1533743 - 0.1471287)/0.1533743*100
# 4.072129

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.010938481 0.053804302 9.934796257 0.009689246 0.098828088 5.064854233 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
#  9.3848069  7.6086049 -0.6520374 -3.1075445 -1.1719125  1.2970847 
