...
mean(bcd.all3.r10[,2]) # 0.1521379
min(bcd.all3.r10[,2]) # 0.1410983

(0.1579845 - 0.1521379)/0.1579845*100
# 3.700743

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.008981025  0.048833560 10.076553842  0.010083855  0.101658217  4.666325179 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -10.1897545  -2.3328803   0.7655384   0.8385502   1.6582165  -6.6734964 
