...
mean(bcd.all3.r10[,2]) # 0.1507305
min(bcd.all3.r10[,2]) # 0.1390135

(0.1576258 - 0.1507305)/0.1576258*100
# 4.374474

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.01115705 0.04616747 9.99527704 0.01008017 0.10060092 4.69821805 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# 11.57047895 -7.66506195 -0.04722956  0.80174443  0.60091666 -6.03563894 
