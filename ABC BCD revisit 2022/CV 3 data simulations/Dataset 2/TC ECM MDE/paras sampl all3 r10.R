...
mean(bcd.all3.r10[,2]) # 0.1420138
min(bcd.all3.r10[,2]) # 0.1350526

(0.1454803 - 0.1420138)/0.1454803*100
# 2.382797

paras.final.est <- apply(paras.all3.r10, 2, mean)
# 0.008822542  0.049736677 10.058956201  0.010233093  0.100565242  4.617619048 
paras.ref <- c(0.01, 0.05, 10, 0.01, 0.1, 5)
(paras.final.est - paras.ref)/paras.ref*100
# -11.7745809  -0.5266466   0.5895620   2.3309285   0.5652421  -7.6476190 
