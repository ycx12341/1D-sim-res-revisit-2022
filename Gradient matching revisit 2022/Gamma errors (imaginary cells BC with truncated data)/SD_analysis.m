% SD_analysis.m
% Author: Yunchen Xiao
% This MATLAB file generates the plots of SD (standard deviation) estimates 
...
% deviations (standard deviations obtained using inverse hessian) and
...
%% Read in all the SDs
std_true = readtable('True SD estimates 5 cv.txt');
std_hess = readtable('Mean SD estimates 5 cv.txt');
std_boots = readtable('Bootstrap SD estimates 5 cv.txt');
...
%% Plot of SDs of dn obtained using the three different methods mentioned above
figure
...
%% Plot of SDs of gamma obtained using the three different methods mentioned above
figure
...
%% Plot of SDs of rn obtained using the three different methods mentioned above
figure
...
%% Plot of SDs of eta obtained using the three different methods mentioned above
figure
...
%% Plot of SDs of dm obtained using the three different methods mentioned above
figure
...
%% Plot of SDs of alpha obtained using the three different methods mentioned above
figure
